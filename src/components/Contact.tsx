...
const Contact = () => {
  ...
  return (
    <section id="contact" className="py-24 bg-white dark:bg-creative-dark">
      <div className="container mx-auto">
        <div className="text-center mb-16">
          <h2 className="section-title inline-block mx-auto mb-4">Contact Me</h2>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-5 gap-12">
          ...
          <div className="lg:col-span-2">
            <div className="bg-gray-50 dark:bg-creative-navy/30 rounded-xl p-6 md:p-8 h-full">
              ...
              <div className="space-y-6">
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <a href="mailto:contact@creativecanvas.com" className="text-gray-600 dark:text-gray-300 hover:text-primary dark:hover:text-primary transition-colors">
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    <h4 className="font-medium text-gray-800 dark:text-white mb-1">Studio Location</h4>
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    <h4 className="font-medium text-gray-800 dark:text-white mb-1">Working Hours</h4>
                    <p className="text-gray-600 dark:text-gray-300">
              ...
              <div className="mt-10">
                ...
                <div className="flex space-x-4">
                  <a href="#" className="bg-gray-200 dark:bg-creative-navy hover:bg-primary hover:text-white dark:hover:bg-primary text-gray-600 dark:text-gray-300 p-2 rounded-full transition-colors">
          ...
          <div className="lg:col-span-3">
            <div className="bg-gray-50 dark:bg-creative-navy/30 rounded-xl p-6 md:p-8">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div>
                    ...
                    <input
                      ...
                      required
                      className="w-full px-4 py-2 border border-gray-300 dark:border-gray-700 rounded-md focus:ring-primary focus:border-primary transition-colors bg-white dark:bg-creative-navy/50 text-gray-900 dark:text-gray-100"
                    />
                  </div>
